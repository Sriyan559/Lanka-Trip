...
use App\Policies\EcosystemModulePolicy;
...
use App\Policies\ReturnCasePolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(ReturnCase::class, ReturnCasePolicy::class);
        Gate::policy(EcosystemModule::class, EcosystemModulePolicy::class);
