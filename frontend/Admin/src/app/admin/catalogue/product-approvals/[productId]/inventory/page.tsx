...
import {
  ArrowLeft, Search, SlidersHorizontal, AlertTriangle, AlertOctagon, XCircle, Clock, ShieldAlert, Package, CheckCircle, ChevronDown, Download, BarChart2, MapPin, MoreVertical, FileText, Info, Box, Bookmark, ChevronRight, X, ExternalLink, Activity, Calendar, Shield, Plus, AlertCircle
} from "lucide-react";
...
export default async function ProductInventoryPage({ params }: { params: Promise<{ productId: string }> }) {
  ...
  // Find product from fixtures or just use generic data if not found
  ...
  return (
    <div className={styles.pageWrapper}>
      <Link href={`/admin/catalogue/product-approvals/${productId}`} className={styles.backLink}>
        <ArrowLeft size={16} />
      ...
      <div className={styles.headerRow}>
        <div className={styles.titleArea}>
          <div className={styles.headerMeta}>
            ...
            <span style={{color: '#9ca3af'}}>&gt;</span>
            <span className={styles.metaLabel}>{productData.id || 'PROD-2024-00421'}</span>
            <span style={{color: '#9ca3af'}}>&gt;</span>
            ...
            <div style={{flex: 1}}>
              ...
              <div className={styles.contextGrid}>
                <div className={styles.metaItem}>
                  ...
                  <div className={styles.metaValue}>{productData.id || 'PROD-2024-00421'}</div>
                </div>
                <div className={styles.metaItem}>
                ...
                <div className={styles.metaItem}>
                  ...
                  <div className={styles.metaValue}>{productData.supplier || 'Luxe Distribution Pvt Ltd'}</div>
                </div>
              </div>
            </div>
            <div className={styles.contextLinks}>
              <Link href={`/admin/catalogue/product-approvals/${productId}`} className={styles.contextLink}>
            ...
            <table className={styles.table}>
              ...
              <tbody>
                <tr>
                  ...
                  <td><div>{product?.supplier || 'Luxe Distribution Pvt Ltd'}</div></td>
                  ...
                  <td><Link href={`/admin/catalogue/inventory/batches/BT-2024-0098`} className={styles.btnAction} style={{textDecoration: 'none', display: 'inline-block'}}>Open Batch</Link></td>
                ...
                <tr>
                  ...
                  <td><Link href={`/admin/catalogue/inventory/batches/BT-2024-0112`} className={styles.btnAction} style={{textDecoration: 'none', display: 'inline-block'}}>Open Batch</Link></td>
                  <td><MoreVertical size={16} color="#6b7280" /></td>
                </tr>
                ...
                <tr>
                  ...
                  <td><Link href={`/admin/catalogue/inventory/batches/RECALL-442`} className={styles.btnAction} style={{textDecoration: 'none', display: 'inline-block'}}>Open Batch</Link></td>
                  <td><MoreVertical size={16} color="#6b7280" /></td>
                </tr>
                ...
                <tr>
                  ...
                  <td>NGO-100ML</td>
                  <td>{product?.id || 'PROD-2024-00421'}1</td>
                  <td>-</td>
                  ...
                  <td><span className={styles.badgeDanger}>High</span></td>
                  <td><Link href={`/admin/catalogue/inventory/batches/BT-2024-0462`} className={styles.btnAction} style={{textDecoration: 'none', display: 'inline-block'}}>Open Batch</Link></td>
                  <td><MoreVertical size={16} color="#6b7280" /></td>
                </tr>
              </tbody>
            </table>
