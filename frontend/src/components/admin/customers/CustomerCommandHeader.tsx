      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-[13px] text-muted mt-1 max-w-3xl leading-relaxed">
            Monitor customer network intelligence, lifecycle, identity, orders, loyalty, service, privacy, risk, and engagement across the beauty marketplace.
          </p>
        </div>

        {/* Top-Right Action Buttons */}
        <div className="flex items-center flex-wrap gap-2.5">
          {/* Export Customer Operations Report */}
          <button
          ...
          >
            ...
            <span>Export Customer Operations Report</span>
          </button>
          ...
          <button
            ...
            className="h-9 px-4 rounded-md bg-[#671021] hover:bg-[#520d1a] text-white text-[12px] font-bold flex items-center gap-1.5 transition-colors shadow-sm"
          >
            <Plus size={15} />
