...
import { RefreshCw, Filter, ShieldCheck, Database, Calendar } from "lucide-react";

interface LogisticsContextBarProps {
  lastSynced?: string;
  onRefresh?: () => void;
}
...
export function LogisticsContextBar({
  ...
  const contextItems = [
    ...
    { label: "Logistics Scope", value: "Active Fulfilment Network" },
