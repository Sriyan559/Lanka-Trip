...
import { 
  Package, Boxes, Layers, CheckSquare, Send, Truck, CheckCircle2, AlertTriangle, RotateCcw, ShieldAlert
} from "lucide-react";
...
export function LogisticsMetricsRow({ metrics }: LogisticsMetricsProps) {
  ...
  const items = [
    ...
    },
    {
      ...
      icon: <Boxes size={12} className="text-amber-600" />,
      stroke: "#d97706",
    ...
    },
    {
      ...
      icon: <Layers size={12} className="text-purple-600" />,
      stroke: "#9333ea",
    ...
    },
    {
      ...
      icon: <CheckSquare size={12} className="text-sky-600" />,
      stroke: "#0284c7",
    ...
    },
    {
      ...
      icon: <Truck size={12} className="text-amber-600" />,
      stroke: "#f59e0b",
    ...
    },
    {
      ...
      icon: <Truck size={12} className="text-emerald-600" />,
      stroke: "#10b981",
    ...
    },
    {
      ...
      icon: <RotateCcw size={12} className="text-purple-600" />,
      stroke: "#a855f7",
