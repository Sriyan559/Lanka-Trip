...
export function FulfilmentDetailLifecycle() {
  const stages = [
    { name: "Fulfilment Created", state: "completed", time: "May 25 18:35" },
    ...
    { name: "Picking Completed", state: "completed", time: "May 25 11:35" },
    { name: "Packing Started", state: "completed", time: "May 25 11:40" },
    { name: "Packing Completed", state: "completed", time: "May 25 12:05" },
    { name: "Quality Check", state: "current", time: "May 25 12:15" },
  ...
  return (
    <div className="bg-white rounded-xl border border-line p-4 shadow-sm space-y-3 text-xs">
