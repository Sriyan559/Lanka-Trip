...
export function FulfilmentIdentitySection({ fulfilmentId = "FUL-2026-0008921" }: FulfilmentIdentitySectionProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-6 gap-3 text-xs">
      ...
      <div className="bg-white p-3.5 rounded-xl border border-line shadow-sm space-y-2">
        <h4 className="font-bold text-ink text-[11px] uppercase tracking-wider border-b border-line pb-1.5">
          Fulfilment Identity
        </h4>
        <div className="space-y-1 text-[11px]">
          ...
          <div className="flex justify-between"><span className="text-muted">Owner:</span><span className="text-ink font-medium flex items-center gap-1"><User size={11} /> Nuwan W.</span></div>
        </div>
      </div>
      ...
      <div className="bg-white p-3.5 rounded-xl border border-line shadow-sm space-y-2">
        ...
        <div className="space-y-1 text-[11px]">
          ...
          <div className="flex justify-between"><span className="text-muted">Payment:</span><strong className="text-emerald-700 bg-emerald-50 px-1.5 py-0.2 rounded border border-emerald-200">Paid</strong></div>
          <div className="flex justify-between"><span className="text-muted">COD:</span><span className="text-muted">No</span></div>
          <div className="flex justify-between"><span className="text-muted">Delivery Address:</span><span className="text-ink font-medium">Colombo 07</span></div>
        </div>
      </div>
      ...
      <div className="bg-white p-3.5 rounded-xl border border-line shadow-sm space-y-2">
        ...
        <div className="space-y-1 text-[11px]">
          <div className="flex justify-between"><span className="text-muted">Supplier:</span><strong className="text-ink">Glow Labs Pvt Ltd</strong></div>
          <div className="flex justify-between"><span className="text-muted">Seller Tier:</span><strong className="text-amber-700 bg-amber-50 px-1.5 py-0.2 rounded border border-amber-200">Gold</strong></div>
          ...
          <div className="flex justify-between"><span className="text-muted">Risk:</span><span className="text-emerald-700 font-bold bg-emerald-50 px-1.5 py-0.2 rounded border border-emerald-200">Low</span></div>
        </div>
      </div>
      ...
      <div className="bg-white p-3.5 rounded-xl border border-line shadow-sm space-y-2">
        ...
        <div className="space-y-1 text-[11px]">
          <div className="flex justify-between"><span className="text-muted">Fulfilment Centre:</span><strong className="text-ink">FC Colombo Central</strong></div>
          ...
          <div className="flex justify-between"><span className="text-muted">Capacity:</span><strong className="text-emerald-700">Healthy</strong></div>
        </div>
      </div>
      ...
      <div className="bg-white p-3.5 rounded-xl border border-line shadow-sm space-y-2">
        ...
        <div className="flex flex-wrap gap-1 text-[10px]">
          {statusSnapshotBadges.map((b, i) => (
            <span key={i} className={`px-2 py-0.5 rounded border ${getBadgeStyle(b.type)}`}>
              {b.label}
            </span>
          ))}
        </div>
