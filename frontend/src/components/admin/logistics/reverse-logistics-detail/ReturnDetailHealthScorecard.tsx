...
interface ReturnDetailHealthScorecardProps {
  onRefresh?: () => void;
  onClearAll?: () => void;
  onSaveView?: () => void;
}

export function ReturnDetailHealthScorecard({
  onRefresh,
  onClearAll,
  onSaveView,
}: ReturnDetailHealthScorecardProps) {
  const scorecardItems = [
    ...
    { label: "Restock Integrity", value: 93, trend: "+1%" },
