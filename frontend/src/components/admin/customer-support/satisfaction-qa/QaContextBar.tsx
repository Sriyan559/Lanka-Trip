    ...
    <div className="bg-white border border-slate-200 rounded-md p-2 shadow-2xs text-[10px] flex flex-wrap items-center justify-between gap-x-3 gap-y-1 text-slate-600">
      ...
      <div className="flex flex-wrap items-center gap-x-3 gap-y-1 border-l border-slate-200 pl-3">
        <div className="flex items-center gap-1">
          <span className="text-slate-400">Survey Source:</span>
        ...
        <span className="text-slate-200">|</span>
        <div className="flex items-center gap-1">
          <span className="text-slate-400">Conversation Source:</span>
          <span className="inline-flex items-center gap-1 text-emerald-700 font-bold">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" />
            Connected
          </span>
      ...
      <div className="flex flex-wrap items-center gap-x-3 gap-y-1 border-l border-slate-200 pl-3">
        <div>
          <span className="text-slate-400 block font-medium">QA Policy</span>
          <span className="font-mono font-bold text-slate-800">SUP-QA-v4</span>
        </div>
        <div>
          <span className="text-slate-400 block font-medium">Active Scorecard</span>
          <span className="font-mono font-bold text-slate-800">QA-SC-v4</span>
        </div>
        <div>
