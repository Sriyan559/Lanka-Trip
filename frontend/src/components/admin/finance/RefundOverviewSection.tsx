...
export function RefundOverviewSection() {
  const totalDonutCount = FN05_DONUT_DATA.reduce((acc, curr) => acc + curr.count, 0);

  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-3">
      {/* ── Left: Refund & Compensation Trend (6 cols) ── */}
      <div className="lg:col-span-6 bg-white border border-gray-200 rounded-xl p-3.5 flex flex-col gap-2">
        <div className="flex items-center justify-between">
          <p className="text-[11px] font-bold text-gray-700 uppercase tracking-wide">
            Refund &amp; Compensation Trend (Last 30 Days)
          </p>
        ...
        <div className="h-44">
          <ResponsiveContainer width="100%" height="100%">
            <ComposedChart data={FN05_TREND_DATA} margin={{ top: 4, right: 8, left: -16, bottom: 0 }}>
      ...
      {/* ── Middle: Refund Type Distribution Donut (3 cols) ── */}
            ...
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie
                  ...
                  paddingAngle={2}
                >
                  {FN05_DONUT_DATA.map((entry, index) => (
      ...
      {/* ── Right: Refund Status Summary (3 cols) ── */}
      <div className="lg:col-span-3 bg-white border border-gray-200 rounded-xl p-3.5 flex flex-col justify-between">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="w-full bg-gray-100 rounded-full h-1 overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${Math.min((row.count / 842) * 100, 100)}%`,
