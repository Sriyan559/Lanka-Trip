  ...
  return (
    <div className="flex flex-col gap-1.5 pb-2 border-b border-gray-200">
      ...
      <nav className="flex items-center gap-1 text-[11px] font-semibold text-gray-500">
        ...
        <span>/</span>
        <span className="text-gray-900 font-bold">Settlements &amp; Payouts</span>
      </nav>
      ...
      <div className="flex flex-col xl:flex-row xl:items-start justify-between gap-3">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5 max-w-4xl leading-relaxed">
            Prepare settlement liabilities, govern payout batches, validate beneficiaries, monitor execution, reserves, holds, funding, reconciliation and marketplace disbursement operations across the beauty ecosystem.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2 flex-wrap shrink-0">
          <button
            onClick={() => toast.success('Exporting Settlement Operations Report...')}
          ...
          >
            <Download size={13} />
            <span>Export Settlement Operations Report</span>
          </button>

          {/* Review Settlement Exceptions dropdown */}
          <div className="relative">
            ...
            >
              ...
              <span>Review Settlement Exceptions</span>
              <ChevronDown size={12} />
            </button>
            {exceptionsOpen && (
              <div className="absolute right-0 top-full mt-1 w-64 bg-white border border-gray-200 rounded-lg shadow-xl py-1 z-40 text-xs font-medium text-gray-700">
                {[
                  '52 Failed Payouts',
                  '42 Active Settlement Holds',
                  '18 Reconciliation Exceptions',
                  '18 Payout SLA Breaches',
                ].map((item) => (
                  <button
                    key={item}
                    onClick={() => {
          ...
          <button
            onClick={() => toast.error('Opening Review Failed Payouts Queue...')}
          ...
          >
            <FileCheck size={13} />
            <span>Review Failed Payouts</span>
          </button>

          <button
            onClick={() => toast.success('Creating Settlement Batch...')}
          ...
          <button
            onClick={() => toast.success('Initiating Create Settlement Review modal...')}
