  ...
  return (
    <div className="flex flex-col gap-1.5 pb-2 border-b border-gray-200">
      ...
      <nav className="flex items-center gap-1 text-[11px] font-semibold text-gray-500">
        ...
        <span>/</span>
        <span className="text-gray-900 font-bold">Supplier Payables</span>
      </nav>
      ...
      <div className="flex flex-col xl:flex-row xl:items-start justify-between gap-3">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5 max-w-4xl leading-relaxed">
            Manage supplier invoice liabilities, deductions, approvals, payment scheduling, disputes, reconciliation
            and audit-ready payable operations across the beauty marketplace.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2 flex-wrap shrink-0">
          ...
          >
            <Download size={13} />
            <span>Export Supplier Payables Report</span>
          </button>

          {/* Review Payable Exceptions dropdown */}
          ...
          >
            <FileCheck size={13} />
            <span>Review Overdue Payables</span>
          </button>
