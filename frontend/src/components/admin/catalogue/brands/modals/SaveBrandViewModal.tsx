...
interface SaveBrandViewModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export const SaveBrandViewModal: React.FC<SaveBrandViewModalProps> = ({
  isOpen,
  onClose,
}) => {
        ...
        <form onSubmit={handleSave} className="p-5 flex flex-col gap-3.5 text-xs">
          <div>
            ...
            <input
              ...
              placeholder="e.g. Expiring APAC Brands"
          ...
          <div className="p-3 bg-gray-50 rounded border border-gray-200 text-[11px] text-gray-600">
            Includes active search query, status tab, verification, authorization, supplier and risk filters.
          </div>
