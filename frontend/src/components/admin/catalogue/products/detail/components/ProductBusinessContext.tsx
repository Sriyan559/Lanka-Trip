...
interface ProductBusinessContextProps {
  onRefresh: () => void;
  isRefreshing?: boolean;
}

export const ProductBusinessContext: React.FC<ProductBusinessContextProps> = ({
  onRefresh,
  isRefreshing = false,
}) => {
  return (
    <div className="bg-white rounded border border-gray-200 px-4 py-2 flex flex-wrap items-center justify-between gap-3 text-[11px] shadow-2xs">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 border-l border-gray-200 pl-3">
          ...
          <span className="text-gray-400 text-[10.5px]">Last updated: 04 May 2026, 11:27 AM</span>
          <button
            onClick={onRefresh}
            title="Refresh record context"
