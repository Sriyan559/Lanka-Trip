...
export function SharedPriorityAlerts({ title, alerts, viewAllText = "View all", layout = "block" }: SharedPriorityAlertsProps) {
  ...
  return (
    <div className="bg-white rounded-xl border border-line p-5 shadow-sm flex flex-col gap-3">
