...
export function CatalogueTopFilterBar() {
  return (
    <div className="bg-white border-b border-line px-6 py-3 flex flex-wrap items-center justify-between">
      <div className="flex items-center gap-8 min-w-max">
        ...
        <div className="flex flex-col">
          <span className="text-[10px] font-bold text-muted">Sales Channels</span>
      ...
      <div className="flex items-center gap-4 min-w-max ml-8">
        ...
        <button className="w-8 h-8 rounded-full hover:bg-slate-100 flex items-center justify-center text-ink transition-colors border border-line">
          <RefreshCw size={14} />
        </button>
      </div>
    </div>
