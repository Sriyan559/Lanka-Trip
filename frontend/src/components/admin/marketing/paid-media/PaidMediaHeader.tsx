...
interface PaidMediaHeaderProps {
  onCreateCampaign?: () => void;
}

export function PaidMediaHeader({ onCreateCampaign }: PaidMediaHeaderProps) {
    ...
    <div className="flex flex-col gap-2 bg-white p-3 sm:p-4 rounded-xl border border-gray-200/80 shadow-2xs">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 text-xs font-medium text-gray-500">
          ...
          <span>/</span>
          <span className="text-gray-900 font-semibold">Paid Media</span>
        </div>

        {/* Header Action Buttons */}
        <div className="flex flex-wrap items-center gap-2">
          {/* 1. Export Paid Media Report */}
          <Link
          ...
          >
            ...
            <span>Export Paid Media Report</span>
          </Link>

          {/* 2. Review Advertising Exceptions */}
          <Link
          ...
          {/* 5. Create Paid Media Campaign (Crimson Primary Button) */}
          <button
