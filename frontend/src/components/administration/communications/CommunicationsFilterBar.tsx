...
import { COMMUNICATIONS_FILTERS, QUICK_FILTERS } from '@/lib/administration/communications/communications.constants';
        ...
        <div className="col-span-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search rules, templates, providers..."
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 pt-2 border-t border-gray-150 text-[10px]">
        <div className="flex items-center gap-1.5 flex-wrap min-w-0">
          ...
          {QUICK_FILTERS.map((qf) => {
            ...
            if (qf.label === 'Healthy' || qf.label === 'Email') colorClass = 'text-emerald-700';
            if (qf.label === 'Warning' || qf.label === 'Retry Queue' || qf.label === 'Needs Attention') colorClass = 'text-amber-700';
            if (qf.label === 'Failed' || qf.label === 'Critical Notification') colorClass = 'text-rose-700';
            if (qf.label === 'Provider Degraded' || qf.label === 'Fallback Active') colorClass = 'text-blue-700';
...
export default CommunicationsFilterBar;
