...
import { DATA_GOVERNANCE_FILTERS, QUICK_FILTERS } from '@/lib/administration/data-governance/data-governance.constants';
        ...
        <div className="col-span-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search assets, policies, domains..."
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 pt-2 border-t border-gray-150 text-[10px]">
        <div className="flex items-center gap-1.5 flex-wrap min-w-0">
          {QUICK_FILTERS.map((qf) => {
            ...
            if (qf.label === 'Classified' || qf.label === 'Personal Data') colorClass = 'text-emerald-700';
            if (qf.label === 'Sensitive Data' || qf.label === 'Retention Due' || qf.label === 'Archive Due' || qf.label === 'Disposal Due') colorClass = 'text-amber-700';
            if (qf.label === 'Restricted Data' || qf.label === 'High Risk' || qf.label === 'Retention Breach' || qf.label === 'Legal Hold') colorClass = 'text-rose-700';
