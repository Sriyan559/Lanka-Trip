...
import { ChevronRight, Save, Play, CheckCircle } from "lucide-react";
...
export default function EditProductMasterPage() {
  ...
  const productId = (params?.productId as string) || 'product-uuid-001';
        ...
        <div className="bg-white border-b border-line px-6 py-4 flex flex-col gap-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-3">
              <Link 
                href={`/admin/catalogue/products/${productId}`} 
