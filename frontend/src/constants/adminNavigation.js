...
export const ADMIN_NAVIGATION = [
  ...
  {id:"customers",label:"Customers",href:"/admin/customers",icon:Users,children:[
    ...
    {id:"addresses-contacts",label:"Addresses & Contacts",href:"/admin/customers/addresses"},
    {id:"orders-purchase-history",label:"Orders & Purchase History",href:"/admin/customers/orders"},
    {id:"returns-disputes",label:"Returns, Refunds & Disputes",href:"/admin/customers/returns"},
    {id:"loyalty-membership",label:"Loyalty, Rewards & Membership",href:"/admin/customers/loyalty"},
    {id:"consent-privacy",label:"Consent, Privacy & Preferences",href:"/admin/customers/privacy"},
    {id:"risk-restrictions",label:"Risk, Restrictions & Fraud Signals",href:"/admin/customers/risk"},
    {id:"support-communications",label:"Support & Communications",href:"/admin/customers/support"},
    {id:"import-export-audit",label:"Import, Export & Audit",href:"/admin/customers/import-export"},
  ]},
