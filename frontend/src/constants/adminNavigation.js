...
export const ADMIN_NAVIGATION = [
  ...
  {id:"customer-support",label:"Customer Support",icon:LifeBuoy,href:"/admin/customer-support/cases",children:[
    ...
    {id:"order-delivery-support",label:"Order & Delivery Support",href:"/admin/customer-support/order-delivery"},
    {id:"returns-refund-support",label:"Returns & Refund Support",href:"/admin/customer-support/returns-refunds"},
  ...
  {id:"analytics",label:"Analytics",icon:BarChart3,href:"/admin/analytics",children:[
    ...
    {id:"executive-performance",label:"Executive Performance",href:"/admin/analytics/executive-performance"},
    {id:"orders-analytics",label:"Orders",href:"/admin/analytics/orders"},
    {id:"sales-revenue",label:"Sales & Revenue",href:"/admin/analytics/sales-revenue"},
    {id:"customers-segments",label:"Customers & Segments",href:"/admin/analytics/customers-segments"},
    {id:"marketplace-sellers",label:"Marketplace & Sellers",href:"/admin/analytics/marketplace-sellers"},
    {id:"products-brands",label:"Products & Brands",href:"/admin/analytics/products-brands"},
    {id:"suppliers-analytics",label:"Suppliers",href:"/admin/analytics/suppliers"},
    {id:"inventory-logistics",label:"Inventory & Logistics",href:"/admin/analytics/inventory-logistics"},
    {id:"marketing-analytics",label:"Marketing",href:"/admin/analytics/marketing"},
    {id:"finance-profitability",label:"Finance & Profitability",href:"/admin/analytics/finance-profitability"},
    {id:"customer-support-analytics",label:"Customer Support",href:"/admin/analytics/customer-support"},
    {id:"risk-compliance",label:"Risk & Compliance",href:"/admin/analytics/risk-compliance"},
